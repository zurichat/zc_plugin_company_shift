      ...
      <form className="outer-container">
        ...
        <div className="">
          <div className="container">
            ...
            <div className="select-employee-options">
              <div className="department-section">
                <label for="department">Department</label>
                <select name="" id="" className="dropdown">
                  <option value="field" className="dropdown-content">
                    Field department{" "}
                  </option>
                  <option value="human resource" className="dropdown-content">
                    Human Resources{" "}
                  </option>
                  <option value="IT" className="dropdown-content">
                    IT
                  </option>
                  <option value="Engineering" className="dropdown-content">
                    Engineering
                  </option>
                </select>
              </div>
